...
- constants
  ...
  - Classes/Enums
    ...
    - UIDataName
      - Holds `String` constants for the names of data fields that are displayed in the UI. This allows for access to search data without a full `String` name, preventing typos from occurring when inserting and accessing data.
    - UIElementName
