...
public class SorterTest {
    ...
    public void testSortTableWithNullComparator() {
        ...
        assert TableUtils.equals(tempTable, testTable) : "Table should remain unchanged when comparator is null";
    }
    ...
    public void testSortTableWithWrongComparatorType() {
        ...
        assert TableUtils.equals(tempTable, testTable) : "Table should remain unchanged when comparator is of the wrong type";
    }
