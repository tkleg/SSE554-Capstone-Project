...
public class RowComparator implements Comparator<Row> {
    ...
    /**
     * Checks is the {@code RowComparator} is equal to another object. First, it checks the other object is a {@code RowComparator}. Then it makes sure the {@code SortType} is the same.
     * 
     * @pre obj is an instance of {@code RowComparator}.
     * @post Returns true if the other object is a {@code RowComparator} with the same {@code SortType}, and false otherwise.
     * @param obj The object to compare with this {@code RowComparator}.
     * @return true if the other object is a {@code RowComparator} with the same {@code SortType}, and false otherwise.
     */
    @Override
    ...
    /**
     * Returns a hash code value for this {@code RowComparator}, which is based on the {@code SortType}.
     * @return A hash code value for this {@code RowComparator}.
     */    
    @Override
    @Generated
    public int hashCode() {
