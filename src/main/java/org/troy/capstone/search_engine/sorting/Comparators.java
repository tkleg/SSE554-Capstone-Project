...
public class Comparators {
    ...
    private static final List<Comparator<Row>> COMPARATORS = List.of(PRICE_ASCENDING, PRICE_DESCENDING, RELEVANCE_ASCENDING, RATING_ASCENDING, RATING_DESCENDING);

    private static final Map<Comparator<Row>, String> comparatorNames = Map.of(
        PRICE_ASCENDING, "Price Ascending",
        PRICE_DESCENDING, "Price Descending",
        RELEVANCE_ASCENDING, "Relevance Ascending",
